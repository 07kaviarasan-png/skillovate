    ...
    <div className="min-h-screen flex bg-[#FCFDFF] z-[100] overflow-y-auto">
      ...
      <div className="hidden lg:flex w-[400px] xl:w-[450px] bg-lp-accent flex-col p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest border border-white/20">
              <ShieldCheck size={12} /> HR & Recruiter Platform
            </div>
            
            <h1 className="text-5xl font-black leading-[1.1]">
              Hire smarter.<br />Source better.
            </h1>
            ...
            <div className="grid grid-cols-2 gap-y-10 gap-x-6 pt-10">
              ...
              <StatItem value="2.4L+" label="Scored profiles" />
              <StatItem value="94%" label="Hire success rate" />
              <StatItem value="30+" label="Partner companies" />
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 pt-10 flex items-center gap-4">
          ...
          <span className="text-xs font-bold text-white/60">Trusted by top MNC recruiters</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F4F7FF] relative">
        ...
        <div className="w-full max-w-[480px] relative z-10">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-black text-lp-text mb-3">HR / Recruiter Login</h2>
            <p className="text-lp-muted font-medium">Sign in to access your talent sourcing dashboard</p>
          </div>

          <div className="bg-white p-10 rounded-[32px] shadow-xl shadow-lp-accent/5 border border-lp-border">
            <div className="bg-lp-surface p-4 rounded-2xl mb-8 flex items-center gap-3 border border-lp-border/50">
              <div className="text-xs font-bold text-lp-text">
                <span className="text-lp-accent">Demo credentials:</span> Any work email & password <span className="font-black">hr123</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-black text-lp-muted uppercase tracking-[0.15em] ml-1">Work Email</label>
              ...
              >
                Access HR Dashboard <ArrowRight size={18} />
              </button>
            </form>

            <div className="mt-8 pt-8 border-t border-lp-border text-center">
              <p className="text-sm text-lp-muted font-medium">
                New company? <Link href="/register" className="text-lp-accent font-black hover:underline">Create Account</Link>
              </p>
            </div>
          </div>
        </div>
