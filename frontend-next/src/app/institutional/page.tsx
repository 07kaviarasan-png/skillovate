        ...
        <div className="relative z-10 flex-1">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest border border-white/20">
              <Zap size={12} /> AI-Powered Aptitude Training
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F4F7FF] relative">
        ...
        <div className="w-full max-w-[480px] relative z-10">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-black text-lp-text mb-3">Institutional Login</h2>
            <p className="text-lp-muted font-medium">Sign in to manage your institution's talent</p>
          </div>
          ...
          <div className="bg-white p-10 rounded-[32px] shadow-xl shadow-lp-accent/5 border border-lp-border">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-black text-lp-muted uppercase tracking-[0.15em] ml-1">Admin/Faculty Email</label>
            ...
            <div className="mt-8 pt-8 border-t border-lp-border text-center">
              <p className="text-sm text-lp-muted font-medium">
                Want to register your institution? <Link href="#" className="text-lp-accent font-black hover:underline">Contact Support</Link>
              </p>
            </div>
          </div>
        </div>
