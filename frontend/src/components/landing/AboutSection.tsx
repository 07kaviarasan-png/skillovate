        ...
        <div className="about-grid">
          <div className="about-content">
            <div className="hero-pill" style={{ background: "var(--lp-accent-light)", color: "var(--lp-accent)" }}>
              The Skillovate Mission
            </div>
            <h2 className="about-title">About Skillovate</h2>
            <div className="about-text">
              <p>
                <strong>Skillovate</strong> is a comprehensive AI-powered web platform developed to support students and
              ...
              <p>
                The core of Skillovate lies in its <strong>aptitude training module</strong>, which offers a wide
              ...
              <p>
                Beyond basic practice, Skillovate incorporates an <strong>advanced AI-based explanation system</strong>{" "}
              ...
              <p>
                Additionally, Skillovate offers a <strong>powerful resume analysis tool</strong> that evaluates resumes
              ...
              <p>
                ...
                admin panel ensures smooth management of users and system functionalities. Overall, Skillovate serves as
